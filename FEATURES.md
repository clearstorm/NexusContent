...
| `provider.wordpress.companion-integration` WordPress companion provider integration | in_progress | - | 0.2.1 | Phase 3 provider discovery, contract-version negotiation, companion calls, caching, and fallback are implemented with tests against the repaired contract. CI verification pending. |
